...
- (void)createGestureRecognizers
{
  ...
  [tripleTapGesture setDelegate:gestureDelegate];
...
{
  [[NSNotificationCenter defaultCenter] postNotificationName:@"TripleTapGesture" object:nil];
}
...
- (void)handleTapGesture:(UITapGestureRecognizer *)sender
{
  ...
  if ([self.receiver respondsToSelector:@selector(handleTapGesture:)]) {
   [self.receiver handleTapGesture:sender];
  }
}
