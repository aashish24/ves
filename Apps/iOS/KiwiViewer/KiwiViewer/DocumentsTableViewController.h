...
@interface DocumentsTableViewController : UITableViewController <UIGestureRecognizerDelegate> {
...
@property BOOL showMidasTopLevelFolders;
@property BOOL showMidasCommunities;
@property BOOL showDropbox;
